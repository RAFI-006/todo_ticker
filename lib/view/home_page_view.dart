                        ...
                        Positioned(
                            ...
                            child: Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  if (viewModel.taskStatusList
                                      .where(
                                          (element) => element.isStart == true)
                                      .isEmpty) {
                                    locator<NavigationService>()
                                        .navigateTo(Routes.addTaskView);
                                  } else {
                                    locator<SnackBarService>()
                                        .showSnackBar(addTaskErrorMsg);
                                  }
                                },
                                child: Container(
      ...
      children: [
        ...
        Padding(
          ...
          child: Text(
            ...
            "\n"
            ""
            "Once task is added you can tap tasks tile to start/pause your tasks.",
