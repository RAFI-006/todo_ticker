...
class AddTaskView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (x) => AddTasksViewModel(),
      child: Consumer<AddTasksViewModel>(
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                Text(
                  "${_viewModel.durationItem.first} : ${_viewModel.durationItem.last.length > 1 ? _viewModel.durationItem.last : "0:${_viewModel.durationItem.last}"} ",
